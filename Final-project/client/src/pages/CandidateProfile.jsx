  ...
  return (
    <div className="bg-gray-100 min-h-screen py-10 px-4">
      <div className="max-w-6xl mx-auto">
        <Link to={-1} className="text-blue-600 hover:underline font-semibold">
          ← Back
        </Link>

        <div className="bg-white rounded-2xl shadow-lg mt-5 p-8">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/3 flex flex-col items-center">
              <img
                src={
                  candidate.profileImage
                    ? `http://localhost:5500${candidate.profileImage}`
                    : `https://ui-avatars.com/api/?name=${encodeURIComponent(
                        candidate.name,
                      )}&background=2563eb&color=fff&size=256`
                }
                alt={candidate.name}
                className="w-44 h-44 rounded-full object-cover border-4 border-blue-600 shadow-lg"
              />
              ...
              <p className="text-gray-500 capitalize mt-2">{candidate.role}</p>

              {resume?.resumeFile && (
                <a
                  href={`http://localhost:5500/uploads/resumes/${resume.resumeFile}`}
                  target="_blank"
            ...
            <div className="flex-1">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <p className="font-semibold capitalize">{candidate.role}</p>
                </div>
              </div>
                  ...
                  <div className="space-y-8">
                    {candidate.education?.length > 0 ? (
                      candidate.education.map((edu, index) => (
                        <div
                          key={index}
                          className="relative border-l-4 border-blue-600 pl-8 pb-8"
                        >
                          <div className="absolute -left-[13px] top-1 w-6 h-6 rounded-full bg-blue-600 border-4 border-white shadow"></div>
                      ...
                      {candidate.experience.map((exp, index) => (
                        ...
                        >
                          <div className="flex justify-between items-start gap-6 flex-wrap">
                            ...
                            <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full h-fit whitespace-nowrap">
                              {exp.startDate || "-"} -{" "}
                  ...
                  (candidate.projects?.length > 0 ? (
                    <div className="grid md:grid-cols-2 gap-6">
                      {candidate.projects.map((project, index) => (
                        <div
                          key={index}
                          className="bg-white rounded-2xl border shadow hover:shadow-xl transition p-6"
                        >
                          <h2 className="text-xl font-bold">
                    ...
                    {Object.entries(candidate.socialLinks || {})
                      ...
                      .map(([platform, url]) => (
                        ...
                        >
                          ...
                          <p className="text-blue-600 break-all mt-2">{url}</p>
                        </a>
                      ))}
                  </div>
                )}
                ...
                {modalType === "career" && (
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-gray-50 rounded-xl p-5">
                      <p className="text-gray-500">Preferred Role</p>
                    ...
                    <div className="bg-gray-50 rounded-xl p-5 md:col-span-2">
                      <p className="text-gray-500">Willing To Relocate</p>
                      <p className="font-bold">
